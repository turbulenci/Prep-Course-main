...
function operadoresLogicos(num1, num2, num3) {
  ...
  //Si num1 es mayor a num2 y a num3 y además es positivo, retornar ---> "Número 1 es mayor y positivo"  2
  ...
  //0 no es ni positivo ni negativo. Si alguno de los argumentos es 0, retornar "Error". 3
